...
import '../../widgets/Admin_custom_bottom_navigation_bar.dart';
...
import '../adminScreen/addBook.dart';

// Existing imports from original code
import '../../models/book.dart';
import '../../utils/constants.dart';
import 'package:ebook_app/screens/home/notification_screen.dart';
import 'package:ebook_app/screens/home/explore_genre_screen.dart';
import 'package:ebook_app/screens/home/genre_book_list_screen.dart';
  ...
  Future<void> getRecommendedBooks() async {
    ...
    if (response.docs.isNotEmpty) {
      ...
      setState(() {
        ...
        isLoading = false;
        _pages[0] = const AdminHomeContent();
      });
    } else {
      setState(() {
        isLoading = false;
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              ...
              if (context.findAncestorStateOfType<_AdminHomeScreenState>() != null) {
                context
