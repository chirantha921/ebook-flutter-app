...
class DiscoverScreen extends StatelessWidget {
  ...
  void _onViewAllTopCharts(BuildContext context) {
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
          builder: (_) =>
              const SearchResultsScreen(searchQuery: 'Harry Potter')),
    );
  }
  ...
  void _onViewAllTopFree(BuildContext context) {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
          builder: (_) => const SearchResultsScreen(searchQuery: 'Free Books')),
    );
  }
            ...
            Row(
              children: [
                ...
                Text(
                  ...
                  style:
                      GoogleFonts.urbanist(fontSize: 12, color: Colors.black87),
                ),
